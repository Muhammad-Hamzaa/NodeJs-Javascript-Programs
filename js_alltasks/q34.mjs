...
const pizza = ['fajita', 'cheesemax', 'afghani']
...
console.log("I like " +pizza[0]+ " too much. I really love eating pizza all the time. Best time to eat pizza is midnight.I really love pizza" )
